...
%% General parameters
% -- Path and files
params.DataPath = fullfile(pwd,'2_SLM_Vesicles_U2OS.tif');    % Path to the SIM stack
...
params.limits = [0.6, 1.05];      % Ring over which the J function is evaluated for initializing (fc = 1)
