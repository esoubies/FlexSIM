...
%% General parameters
% -- Path and files
params.DataPath = fullfile(pwd,'6_SLM_Mitochondria_2.tif');    % Path to the SIM stack
...
try
    if ~exist(params.DataPath, 'file')
        ...
        y = double(loadtiff([pwd,'/Supplementary code and data/Test/RawImage/Ours/488_2.tif'])); 
...
params.mu =  7e-6;                % Regularization parameter
