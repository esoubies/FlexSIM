...
%% General parameters
% -- Path and files
params.DataPath = fullfile(pwd,'6_SLM_Actin_2.tif');    % Path to the SIM stack
...
try
    if ~exist(params.DataPath, 'file')
        ...
        y = double(loadtiff([pwd,'/Supplementary code and data/Test/RawImage/Ours/561_2.tif'])); 
...
params.mu =  8e-5;                % Regularization parameter
