...
%% General parameters
% -- Path and files
params.DataPath = fullfile(pwd,'6_SLM_Mitochondria_1.tif');    % Path to the SIM stack
...
try
    if ~exist(params.DataPath, 'file')
        ...
        y = double(loadtiff([pwd,'/Supplementary code and data/Test/RawImage/Ours/488_1.tif'])); 
